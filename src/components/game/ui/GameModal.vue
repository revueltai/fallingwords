...
import ModalGameSummary from '@/components/ui/modals/ModalGameSummary.vue'
...
const gameOverlayRef = ref<RefElement>(null)
...
<template>
  ...
  >
    <div class="relative w-full h-full">
      <div class="z-20 absolute w-full h-full bg-secondary-dark opacity-70 left-0 top-0" />
